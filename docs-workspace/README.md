...
| **Recalage runtime 2026-06** | [`DOC_RUNTIME_UPDATE_2026-06.md`](DOC_RUNTIME_UPDATE_2026-06.md), [`DOC_RUNTIME_UPDATE_2026-06-30.md`](DOC_RUNTIME_UPDATE_2026-06-30.md), [`audit-ui-runtime-2026-06/`](audit-ui-runtime-2026-06/) | Synthèse audits UI admin + seeds / learner v2 / fiabilité formateur | Après le socle — avant d'implémenter des ajustements UX front |
...
| `11_FICHE_COMPTES_ET_DONNEES_DEMO.md` | Comptes, groupes, bootstrap, checklist pré-démo |
| `seed-strategies.md` | Stratégies de seed — commandes, idempotence, rattachements |
| `memo-cto-depuis-dernier-push.md` | Mémo CTO — synthèse travaux récents |
...
7. **`rapport_mise_a_jour_doc_post_tests_2026-06-18.md`** — Campagne pytest 18/06.
8. **`memo-cto-depuis-dernier-push.md`** — **Delta depuis dernier push GitHub (20/06/2026)** — à lire avant handover ou release.
9. **`02_ETAT_MOTEUR_REEL.md`** puis **`03_ETAT_PRODUIT_REEL.md`** — Ancrage code et surfaces.
...
**Exemple fil directeur — seeds et comptes de test :** `seed-strategies.md` → doc **11** → commande `bootstrap_*` → fixtures `*.generated.json` → tests `test_demo_test_2_seed.py`.
...
|------|---------------|--------|
| 2026-06-30 | conv-hugo-doc | Nav formateur prod (entrée knowledge, référentiels shell prod, « Chat apprenant ») ; complète passe 30/06. |
| 2026-06-30 | conv-hugo-doc | Seeds OF_test_2, `seed-strategies.md`, mémo CTO (ancré push **20/06**), learner UI v2 + fiabilité formateur dans 03/08/11/09 ; `DOC_RUNTIME_UPDATE_2026-06-30.md`. |

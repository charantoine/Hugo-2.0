...
> **Mise à jour 30/06/2026 — navigation formateur :** entrée TRAINER → `/app/trainer/knowledge` ; référentiels globaux en shell prod (`/app/trainer/referentials`) ; topbar « Chat apprenant ». **Limite :** `/group/:id/referential` reste testeur — voir `03_ETAT_PRODUIT_REEL.md` §2.3.

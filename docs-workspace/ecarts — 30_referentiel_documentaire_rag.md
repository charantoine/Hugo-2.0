...
> **Mise à jour post-cluster 16 — 2026-06-18** · **Confirmé local :** RAG lexical gouverné. **Cluster 16 :** pas d'impact direct (badge Appui inchangé). **CIBLE :** pgvector.
...
## 14. Mise à jour cluster 13 — clôture RAG lot courant

**Sources :** `cluster13_rag_referentiel_documentaire_plan_resultats.md` · audit code `rag_support.py`, `hugo_orchestrator.py` (2026-06-18).

| Point | Statut cluster 13 |
|---|---|
| RAG lexical gouverné | **ALIGNE** — `select_rag_chunks`, tests tracing |
| pgvector / embeddings | **INACTIF** — décision **OFF Couronne** |
| Hiérarchie contexte v1 | **DOC LIVRÉ** — contrat cluster 13 §5 |
| Citations badge Appui | **ALIGNE** — `_compact_rag_citations`, front prod |
| Panneau RAG apprenant | **ABSENT** — conforme doctrine |
| DocumentContextBundle | **P2 Couronne** — non bloquant |
| Encoors parité RAG | **A_VÉRIFIER** |
| Cohérence cluster 12 (31) | **OK** — badge Appui, pas de panneau autonome |

**Décision CTO cluster 13 :** clôturer domaine 30 lot courant en **DOC** ; vectoriel repoussé ; CODE P0 = aucun.

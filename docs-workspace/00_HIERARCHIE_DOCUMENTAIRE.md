...
| **Comptes et données de démo ?** | `11_FICHE_COMPTES_ET_DONNEES_DEMO.md` ; parcours `09` ; profil démo `08` §5 ; **seeds** `seed-strategies.md` | Identifiants hors repo sans recoupement doc 11 |
...
| 11 | `11_FICHE_COMPTES_ET_DONNEES_DEMO.md` | Comptes, groupes, bootstrap, checklist pré-démo |
| — | `seed-strategies.md` | Stratégies de seed / bootstrap / idempotence (juin 2026) |
| — | `superadmin_mode_testeur_ANALYSE.md` | Divergence bloc Mode testeur vs exports Felix/Qualiopi lite |

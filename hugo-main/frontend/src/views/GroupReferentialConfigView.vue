...
onMounted(async () => {
  await Promise.all([loadReferentials(), loadConfig()])
})
</script>
  ...
  <div class="container-fluid">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><router-link :to="{ name: 'Group', params: { groupId } }">Groupe</router-link></li>
        <li class="breadcrumb-item active" aria-current="page">Référentiel du groupe</li>
      </ol>
    </nav>

            ...
            <template v-else-if="group">
              ...
              <div class="mb-3">
                ...
                <p class="text-muted small mb-0 mt-1">
                  Grammaire d’affichage du workspace apprenant (distinct du profil d’engagement A/B/C).
                </p>
                <p v-if="displayProfileError" class="text-danger small mb-0">
                  {{ displayProfileError }}
                </p>
              </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="row g-2 mb-2">
                    <div class="col-12 col-md-6">
                      <label class="form-label small mb-1">Type de savoir</label>
                      <select v-model="newDocKnowledgeType" class="form-select form-select-sm">
                        <option value="knowledge">knowledge</option>
                        <option value="diagnostic">diagnostic</option>
                        <option value="revision">revision</option>
                        <option value="checklist">checklist</option>
                        <option value="safety">safety</option>
                        <option value="mastery_criteria">mastery_criteria</option>
                        <option value="mistake_pattern">mistake_pattern</option>
                        <option value="reflection">reflection</option>
                      </select>
                    </div>
                    <div class="col-12 col-md-6">
                      <label class="form-label small mb-1">Priorité formateur</label>
                      <select v-model="newDocTrainerPriority" class="form-select form-select-sm">
                        <option value="normal">normal</option>
                        <option value="high">high</option>
                      </select>
                    </div>
                    <div class="col-12">
                      <label class="form-label small mb-1">Profils visés</label>
                      <input
                        v-model="newDocIntendedProfiles"
                        type="text"
                        class="form-control form-control-sm"
                        placeholder="reflective_afest, diagnostic, knowledge_review"
                      />
                    </div>
                    <div class="col-12">
                      <label class="form-label small mb-1">Critères de maîtrise</label>
                      <input
                        v-model="newDocMasteryCriteria"
                        type="text"
                        class="form-control form-control-sm"
                    ...
                    <div class="col-12">
                      <label class="form-label small mb-1">Erreurs fréquentes</label>
                      <input
                        v-model="newDocCommonMistakes"
                        type="text"
                        class="form-control form-control-sm"
                    ...
                    <div class="col-12">
                      <label class="form-label small mb-1">Points de raisonnement attendus</label>
                      <input
                        v-model="newDocReasoningPoints"
                        type="text"
                        class="form-control form-control-sm"
                        placeholder="séparés par des virgules"
                      />
                      ...
                      <tr v-for="d in orgDocuments" :key="d.id">
                        ...
                        <td>
                          <div class="d-flex flex-wrap gap-1">
                            <span class="badge bg-light text-dark border">{{ d.meta?.knowledge_type || 'knowledge' }}</span>
                            <span
                              v-if="d.meta?.trainer_priority === 'high'"
                              class="badge bg-warning-subtle text-warning-emphasis border"
                            >
                              priorité haute
                            </span>
                            <span
                              v-for="profile in (d.meta?.intended_profiles || []).slice(0, 2)"
                              :key="`${d.id}-${profile}`"
                ...
                <ul v-if="groupLibraryItems.filter((x) => x.status === 'ACTIVE').length" class="list-group list-group-flush small">
                  ...
                  >
                    <div>
                      ...
                      <div v-if="item.document_meta" class="small text-muted mt-1">
                        {{ item.document_meta.knowledge_type || 'knowledge' }}
                        <span v-if="item.document_meta.trainer_priority === 'high'"> · priorité haute</span>
                      </div>
                    </div>
                    <button
                      type="button"
      ...
      <div class="col-12 col-lg-8 mb-4">
        <div class="card shadow-sm h-100">
          <div class="card-body">
            ...
            <hr class="my-3" />
            <h3 class="h6 mb-2">Rattacher un utilisateur</h3>
            <div v-if="memberSuccess" class="alert alert-success py-2" role="alert">
              {{ memberSuccess }}
            </div>
            <div class="row g-2 align-items-end mb-3">
              <div class="col-12 col-md-9">
                ...
                >
                  ...
                  <option
                    v-for="user in availableUsersForMembership()"
                    :key="user.id"
                    :value="user.id"
                  >

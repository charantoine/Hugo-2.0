...
<template>
  ...
  >
    <div class="card-body">
      ...
      <div v-if="!hideCtaButtons" class="d-flex flex-wrap gap-2 mt-4">
        <button
      ...
      <p
        v-if="!hideCtaButtons && model.evaluationButton.visible && model.evaluationButton.advisory && model.evaluationButton.helperText"
      ...
      <p
        v-else-if="!hideCtaButtons && model.evaluationButton.visible && (model.evaluationButton.helperText || model.evaluationTriggerMessage)"
        class="small text-muted mt-3 mb-0"
      >
        {{ model.evaluationButton.helperText || model.evaluationTriggerMessage }}
      </p>
      <p
        v-if="!hideCtaButtons && model.synthesisButton.visible && model.synthesisButton.helperText"
        class="small text-muted mt-2 mb-0"
      >
        {{ model.synthesisButton.helperText }}
      </p>
      <ul
        v-if="!hideCtaButtons && model.evaluationButton.blockingReasons?.length && model.evaluationButton.disabled"
        class="small text-muted mt-2 mb-0"
      >
